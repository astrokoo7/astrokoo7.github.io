...
수많은 오브젝트가 서로 가려져 있는 환경을 그린다면 이런 비효율은 더욱 가중될 것이다. 
...
Depth/Stencil Test에 대해 Pixel Shader 이후에 처리하도록 명시하고 있다.
...
만약 Pixel Shader 전에 Depth Test한다면 어떻게 될까?

예를 들어, 

Pixel Shader 전에 Depth Test를 통과하여 Depth value를 갱신했는데 
