...
물리적인 2배의 전기 신호는 지수값 2.2에 비례하는 밝기를 출력했는데 이를 `감마`라고 한다.

> <font size="2"> 
> 밝기는 0.0에서 1.0의 값이다. (HDR 모니터는 제외)
> </font>
...
선형적으로 밝아짐을 표현하면 인간은 아래처럼 어두운 곳에서 작은 빛의 변화만으로도 밝아짐을 느껴 어두운 표현을 많이 할 수 없다.
